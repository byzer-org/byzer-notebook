...
--labels: add column
--tag: 1.0.0
ALTER TABLE `job_info` ADD COLUMN `console_log` LONGTEXT NULL AFTER `result`, ADD COLUMN `console_log_offset` int(11) NULL AFTER `console_log`;
...
--labels: add index
--tag: 1.0.0
ALTER TABLE `connection_info` ADD UNIQUE INDEX `unique_cname`(`name`) USING HASH;
